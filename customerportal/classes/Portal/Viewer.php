...
function get_logo() {
	/*2021-01-07 Thet Phyo Wai Update Customer Portal Logo MSCRM Start*/
	/*return 'layouts/'.portal_layout().'/resources/images/application.png';*/
	return 'layouts/'.portal_layout().'/resources/images/MS_CRM_System_Icon.png';
	/*2021-01-07 Thet Phyo Wai Update Customer Portal Logo MSCRM End*/
}
