...
class Portal_ExportRecords_API extends Portal_FetchRecords_API {
	...
	public function process(Portal_Request $request) {
		...
		/*2021-01-12 Thet Phyo Wai Export Not Working in Customer Portal MSCRM Start*/
		/*$response->setResult($this->processResponse($parsedResult, $module, $language, true));*/
		$response->setResult($parsedResult);
		/*2021-01-12 Thet Phyo Wai Export Not Working in Customer Portal MSCRM End*/
		return $response;
	}
