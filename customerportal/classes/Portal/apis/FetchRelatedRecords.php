...
class Portal_FetchRelatedRecords_API extends Portal_Default_API {
	...
	public function process(Portal_Request $request) {
		...
		$response->setResult($this->processResponseNew($result, $request->get('relatedModule'), $language)); 
	...
	public function processResponseNew($result, $relatedModule, $language, $isExport = false) {
	// 2020/12/18 sulatt Customer portal can't at php 7 MSCRM end
		$response = array();
