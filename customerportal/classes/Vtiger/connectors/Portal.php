...
class Vtiger_Portal_Connector extends Vtiger_PortalBase_Connector {
	...
	public function uploadAttachment($module, $parentId = '') {
		...
		$url = 'https://www.activebizs.com/MSCRM_Release/modules/CustomerPortal/api.php';
		...
		if (isset($_FILES)) {
			...
			// Nyaine chan 2021/01/11 Document can't upload Problem MSCRM start
			curl_setopt ($resource, CURLOPT_SSL_VERIFYHOST, FALSE);
			curl_setopt ($resource, CURLOPT_SSL_VERIFYPEER, FALSE);
			// Nyaine chan 2021/01/11 Document can't upload Problem MSCRM end
