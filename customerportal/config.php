...
class Portal_Config_Data {
	...
	protected static $data = array(
		...
		'crm.url' => 'https://www.activebizs.com/MSCRM_Release',

		//Portal URL without trialing/
		//Example: http://yourdomain.com/portal
		'portal.url' => 'https://www.activebizs.com/MSCRM_Release/customerportal',
		...
		'username' => 'mscrm_user',
		'password' => 'Jz*P?,f{5Hbq',
		'database' => 'yutani_mscrm20k01',
	...
	protected static function getData() {
		...
		// self::$data['servername'] = 'localhost';
		// self::$data['username'] = 'root';
		// self::$data['password'] = '';
		// self::$data['database'] = 'mainscrm_1016';
