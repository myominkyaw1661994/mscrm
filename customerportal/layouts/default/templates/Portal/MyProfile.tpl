		...
		<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 leftEditContent" style="border-right:none;">
			...
			<div class="row">
				...
				<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12 rightEditContent" style="background:none;border-left:none;min-height:60%">
					{literal}
					<!--2021-01-07 Thet Phyo Wai Remove First Name of Contact MSCRM Start-->
					...
					<!--2021-01-07 Thet Phyo Wai Remove First Name of Contact MSCRM End-->
					<div class="row profile-fields">
						<!--2021-01-07 Thet Phyo Wai Update Last Name of Contact MSCRM Start-->
						...
						<!--2021-01-07 Thet Phyo Wai Update Last Name of Contact MSCRM End-->
