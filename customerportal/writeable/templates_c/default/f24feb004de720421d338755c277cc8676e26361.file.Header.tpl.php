<?php /* Smarty version Smarty-3.1.19, created on 2021-01-12 11:59:21
         compiled from "F:\Project\MSCRM_Release\customerportal\layouts\default\templates\Header.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1108558775ffd33b16ce405-27424434%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'f24feb004de720421d338755c277cc8676e26361' => 
    array (
      0 => 'F:\\Project\\MSCRM_Release\\customerportal\\layouts\\default\\templates\\Header.tpl',
      1 => 1609835271,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1108558775ffd33b16ce405-27424434',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5ffd33b19d85b6_64773590',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5ffd33b19d85b6_64773590')) {function content_5ffd33b19d85b6_64773590($_smarty_tpl) {?>
...
">
				...
				<div class="col-lg-8 col-md-8 col-sm-6 col-xs-6 portalnavbar" ng-if="loginUser">
					<ul class=" nav navbar-nav headerLinks menu" ng-show="modules">
						...
						<!--2020-01-05 Thet Phyo Wai Remove Product in Customer Portal MSCRM Start-->
						...
						<li class="hidden-md hidden-sm hidden-lg" ng-repeat="module in modules|orderBy:'order'" ng-if="module!=='language' && module.name!=='ProjectTask' && module.name!=='ProjectMilestone' && module.name!=='Products'" ng-class="{'active':isActive(module.name)}">
						<!--2020-01-05 Thet Phyo Wai Remove Product in Customer Portal MSCRM End-->
						...
						<li class="hidden-xs hidden-sm" ng-repeat="module in modules|orderModulesBy:'order'" ng-if="module!=='language' && module.name!=='ProjectTask' && module.name!=='ProjectMilestone' && module.name!=='Products'" ng-class="{'active':isActive(module.name)}">
						<!--2020-01-05 Thet Phyo Wai Remove Product in Customer Portal MSCRM End-->
						...
						<li class="hidden-xs hidden-sm hidden-md visible-lg" ng-repeat="module in modules|orderModulesBy:'order'" ng-if="module!=='language' && module.name!=='ProjectTask' && module.name!=='ProjectMilestone' && module.name!=='Products'" ng-class="{'active':isActive(module.name)}">
						<!--2020-01-05 Thet Phyo Wai Remove Product in Customer Portal MSCRM End-->
						...
						<li class="hidden-xs navbartoggle" ng-if="modulesCount > 5">
							...
							<ul class="dropdown-menu">
								...
								<li class="hidden-md hidden-lg" ng-repeat="module in modules|orderModulesBy:'order'" ng-if="module!=='language' && module.uiLabel!==undefined && module.name!=='ProjectTask' && module.name!=='ProjectMilestone' && module.name!=='Products'" ng-class="{'active':isActive(module.name)}">
								<!--2020-01-05 Thet Phyo Wai Remove Product in Customer Portal MSCRM End-->
								...
								<li class="hidden-lg" ng-repeat="module in modules|orderModulesBy:'order'" ng-if="module!=='language' && module.name!=='ProjectTask' && module.name!=='ProjectMilestone' && module.name!=='Products'" ng-class="{'active':isActive(module.name)}">
								<!--2020-01-05 Thet Phyo Wai Remove Product in Customer Portal MSCRM End-->
									<a ng-if="$index >1  && $index <=4" translate="{{module.uiLabel}}" href="index.php?module={{module.name}}">{{module.uiLabel}}</a>
								</li>
								<!--2020-01-05 Thet Phyo Wai Remove Product in Customer Portal MSCRM Start-->
								...
								<li ng-repeat="module in modules|orderModulesBy:'order'" ng-if="module!=='language' && module.name!=='ProjectTask' && module.name!=='ProjectMilestone' && module.name!=='Products'" ng-class="{'active':isActive(module.name)}">
								<!--2020-01-05 Thet Phyo Wai Remove Product in Customer Portal MSCRM End-->
