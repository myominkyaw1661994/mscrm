                ...
                <div class="modal-body row" style="height:550px;">
                    ...
                    {else}
                        ...
                        {else if $PDF_FILE_TYPE eq 'yes'}
                            {*2020/10/29 Su Latt PDF file preview problem MS CRM Ver 1.0 start*}
                            ...
                            <iframe id='viewer' src="libraries/jquery/pdfjs/web/viewer.html?file=https://www.activebizs.com/MSCRM_Release/{$DOWNLOAD_URL|escape:'url'}" height="100%" width="100%">
                            {*2020/10/29 Su Latt PDF file preview problem MS CRM Ver 1.0 end*}
