...
* All Rights Reserved.
************************************************************************************}
{* modules/HelpDesk/views/ListPriceUpdate.php *}
		...
		<form class="form-horizontal" id="listPriceUpdate" method="post" action="index.php">
			<div class="modal-body">
                ...
                <div class="form-group">
                    <label class="col-sm-4 control-label">{vtranslate('LBL_EDIT_QTY',$MODULE)} <span class="redColor">*</span>&nbsp;</label>
                    <div class="controls col-sm-4">
                        <input type="text" name="currentQty" value="{$CURRENT_QTY}" data-rule-required="true" class="inputElement" data-rule-currency="true"/>
                    </div>
                </div>
                <div class="form-group">
