...
Vtiger_RelatedList_Js("HelpDesk_RelatedList_Js",{},{
	...
	getPopupParams : function(){
		...
		if (jQuery.inArray(relatedModuleName, ["Products", "Services", "HelpDesk"]) == -1) {
			return this._super();
		}
		var parameters = {
			...
			'src_record' : this.parentRecordId,
			 'view' : "TicketProductPopup",
			 'src_field' : 'ticketRelatedList',
			'multi_select' : true,
