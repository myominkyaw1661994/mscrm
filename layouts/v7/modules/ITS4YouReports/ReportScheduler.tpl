        ...
        <div class="row">
            <div class="form-group">
                ...
                <div class="col-lg-4">
                    ...
                    <label class="checkbox" style="margin-left: 30px;display: inline;"><input name="scheduledReportFormat_csv"
                                                                                              id="scheduledReportFormat_csv" {if $REPORT_FORMAT_CSV eq 'true'} checked {/if}
                                                                                              type="checkbox"/>&nbsp;{vtranslate('LBL_REPORT_FORMAT_CSV', $MODULE)}</label>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="form-group">
                <label class="col-lg-2 control-label textAlignLeft">
                    {vtranslate('LBL_REPORT_CSV_PATH',$MODULE)}
                </label>
                <div class="col-lg-4">
                    <input type="text" class="inputElement" data-rule-required="false" name="csv_path" id="csv_path"
                           placeholder="... /test/ITS4YouReports/" value="{$CSV_PATH}" {if $REPORT_FORMAT_CSV neq 'true'}disabled{/if} style="width:65%;" />
                    <input type="text" class="inputElement" data-rule-required="false" name="csv_name" id="csv_name"
                           placeholder="... fileName.csv" value="{$CSV_NAME}" {if $REPORT_FORMAT_CSV neq 'true'}disabled{/if} style="width:35%;" />
                </div>
            </div>
        </div>
