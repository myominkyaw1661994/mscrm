...
<div class="details block">
                        ...
                        {if $LIST_PRICE_VIEWABLE}
                            <td style="white-space: nowrap;">
                                <div>
                                 ...
                                 {*2020-10-17 Su Latt Naing Remove Individual Discount MSCRM var 1.0 Delete Start*}
                                {*{if $ITEM_DISCOUNT_AMOUNT_VIEWABLE || $ITEM_DISCOUNT_PERCENT_VIEWAB{*LE}
                                    <div>
                                ...
                                {*2020-10-17 Su Latt Naing Remove Individual Discount MSCRM var 1.0 Delete End*}
    ...
    <table class="table table-bordered lineItemsTable">
        ...
        {/if}
	{*2020/10/09 sulatt remove DEDUCTED_TAXES_INFO at inventory MSCRM ver 1.0 start*}
        {*<tr>
            <td width="83%">
                <div align="right">
	...
	{*2020/10/09 sulatt remove DEDUCTED_TAXES_INFO at inventory MSCRM ver 1.0 end*}
        <tr>
            <td width="83%">
                <div align="right">
