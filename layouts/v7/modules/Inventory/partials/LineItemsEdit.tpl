			...
			<div class="row">
				...
				<div class="col-lg-3 col-md-3 col-sm-3" style="top: 3px;">
					<center>
						...
						{*2020-11-17 Thet Phyo Wai Change Currency Readyonly MSCRM Var 1.0 Start*}
						<p class="message-text hide" style="color:#D95252;margin-top: 3px;">Please must be click "Save" button for change currency.</p>
						{*2020-11-17 Thet Phyo Wai Change Currency Readyonly MSCRM Var 1.0 End*}
					</center>
				</div>
					...
					<tr valign="top">
						...
						<td>
							{if $MODULE eq 'Invoice'}
								...
								<span class="pull-right"><input id="paid" name="paid" type="text" class="lineItemInputBox form-control" value="{if $RECORD->getDisplayValue('paid') && !($IS_DUPLICATE)}{$RECORD->getDisplayValue('paid')}{else}0{/if}"></span>
