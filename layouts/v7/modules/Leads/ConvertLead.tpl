            ...
            {else}
                ...
                <form class="form-horizontal" id="convertLeadForm" method="post" action="index.php">
                    ...
                    <div class="modal-body accordion container-fluid" id="leadAccordion">
                        ...
                        {*2020-10-23 Thet Phyo Wai Remove Potentials in Convert Lead MSCRM Ver 1.0 Start*}
                        {if $MODULE_NAME eq 'Potentials'}
                            {continue}
                        {/if}
                        {*2020-10-23 Thet Phyo Wai Remove Potentials in Convert Lead MSCRM Ver 1.0 End*}
                            <div class="row">
