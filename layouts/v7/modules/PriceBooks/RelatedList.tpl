							...
							<tr class="searchRow">
								...
								{foreach item=HEADER_FIELD from=$RELATED_HEADERS}
									<th>
										...
										{if $HEADER_FIELD->get('column') eq 'time_start' or $HEADER_FIELD->get('column') eq 'time_end' or $HEADER_FIELD->getFieldDataType() eq 'reference' or $HEADER_FIELD->get('name') eq 'listprice'}
