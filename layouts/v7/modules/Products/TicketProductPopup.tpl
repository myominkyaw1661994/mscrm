 ...
 * All Rights Reserved.
 ************************************************************************************}
{* modules/Products/views/TicketProductPopup.php *}

{* START YOUR IMPLEMENTATION FROM BELOW. Use {debug} for information *}
{strip}
	<script type="text/javascript" src="{vresource_url('layouts/v7/modules/HelpDesk/resources/TicketPopup.js')}"></script>
                    ...
                    <div id="popupPageContainer" class="contentsDiv">
                        ...
                        {/if}
                            <div id="popupContents" class="">
                                {include file='TicketProductPopupContents.tpl'|@vtemplate_path:$PARENT_MODULE}
                            </div>
                    </div>
                </div>
                        ...
                        <center>
                            <footer>
                                <button class="btn btn-success addProducts" type="submit">
                                    ...
                                    <strong>{vtranslate('LBL_ADD_TO_TICKET', $MODULE)}</strong>
                                </button>
