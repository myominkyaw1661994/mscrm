...
},
{
	...
	registerEventForEnableCurrency: function() {
		...
		jQuery(container).on('change', '.enableCurrency', function(e) {
			...
			/*2020-10-22 Thet Phyo Wai Default Currency Remove MSCRM Ver 1.0 Start*/
			var elem_name = elem.attr('name');
			/*2020-10-22 Thet Phyo Wai Default Currency Remove MSCRM Ver 1.0 End*/
			...
			if (elem.is(':checked')) {
				...
				/*2020-10-22 Thet Phyo Wai Default Currency Remove MSCRM Ver 1.0 Start*/
				thisInstance.getForm().find('[name="'+elem_name+'"]').val('on');
				/*2020-10-22 Thet Phyo Wai Default Currency Remove MSCRM Ver 1.0 End*/
			} else {
				...
				/*2020-10-22 Thet Phyo Wai Default Currency Remove MSCRM Ver 1.0 Start*/
				thisInstance.getForm().find('[name="'+elem_name+'"]').val('');
				/*2020-10-22 Thet Phyo Wai Default Currency Remove MSCRM Ver 1.0 End*/
			}
		})
		return this;
