...
<html>
    ...
    <!--2020-06-25 Thet Phyo Wai All report result can't show in PDF output start-->
    ...
    <!--2020-06-25 Thet Phyo Wai All report result can't show in PDF output end-->
            ...
            /*2020-06-25 Thet Phyo Wai All report result can't show in PDF output start*/
               /* var splitted = false;
                ...
                $(function () {
                    ...
                    for (var i = 0; i < rows.length - 1; i=i+10) {
                        var newTable = table.clone();
                        header.clone().appendTo(newTable);
                        $('<tbody />').appendTo(newTable);
                        rows.slice(i, i + 10).appendTo(newTable.children('tbody'));
                        newTable.appendTo("#_split_table_wrapper");
                        if (rows.length != i+10) {
                            $('<div style="page-break-after: always; margin:0; padding:0; border: none;"></div>').appendTo("#_split_table_wrapper");
                        }
