...
Vtiger.Class('Settings_Customer_Portal_Js', {}, {
	...
	sanitizeFormData: function (form) {
		...
		/*2021-01-14 Thet Phyo Wai Mandatory Field Check Remove for ticket MSCRM Start*/
		/*var isAllMandatoryFieldsSelected = function (mandatoryFields, selectedFields) {*/
		var isAllMandatoryFieldsSelected = function (mandatoryFields, selectedFields, moduleName) {
		/*2021-01-14 Thet Phyo Wai Mandatory Field Check Remove for ticket MSCRM End*/
		...
		jQuery.each(portalModules, function (index, element) {
			...
			if (moduleName != 'Dashboard') {
				...
				if (typeof moduleFields != 'undefined') {
					...
					if (fieldInfo != 'null' && isAllMandatoryFieldsSelected(mandatoryFields, JSON.parse(fieldInfo),moduleName)) {
					/*2021-01-14 Thet Phyo Wai Mandatory Field Check Remove for ticket MSCRM End*/
