...
Settings_Vtiger_Index_Js("Settings_ITS4YouFieldMapping_DetailView_Js", {
    ...
    deleteLink: function () {
        ...
        jQuery('.links .deleteLink').on('click', function () {
            ...
            app.helper.showConfirmationBox({message: app.vtranslate('JS_DELETELINK_QUESTION')}).then(function () {
    ...
    convertLink: function () {
        ...
        jQuery('.links .relationAdd').on('click', function () {
            ...
            app.helper.showConfirmationBox({message: app.vtranslate('JS_CONVERLINK_QUESTION')}).then(function () {
                window.location.href = url;
            });
        });
    },
