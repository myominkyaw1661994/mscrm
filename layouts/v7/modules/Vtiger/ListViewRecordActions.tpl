    ...
    <span class="more dropdown action">
        ...
        <ul class="dropdown-menu">
            ...
            {*2020-11-23 Thet Phyo Wai Permission for Edit MSCRM Ver 1.0 Start*}
                ...
                {if $RECORD_ACTIONS['edit'] and !($IS_EDIT and (($MODULE eq 'PurchaseOrder' and $LISTVIEW_ENTRY->get('approve') eq 'Yes') or ($MODULE eq 'Invoice' and $LISTVIEW_ENTRY->get('invoicestatus') eq 'Paid') ))}
