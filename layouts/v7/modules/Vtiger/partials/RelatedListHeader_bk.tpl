			...
			<div class="col-lg-6 col-md-6 col-sm-6 btn-toolbar">
				 {foreach item=RELATED_LINK from=$RELATED_LIST_LINKS['LISTVIEWBASIC']}
					<div class="btn-group">
						...
						{*2020-10-03 Thet Phyo Wai Remove Select Relation MSCRM Ver 1.0 Start*}
						  {if $MODULE eq "HelpDesk" and ($RELATED_MODULE_NAME eq 'Products' or $RELATED_MODULE_NAME eq 'Services') and $PARENT_RECORD->get('ticketstatus') eq 'Closed'}
						  </div>
						  {continue}
						  {/if}
						{*2020-10-03 Thet Phyo Wai Remove Select Relation MSCRM Ver 1.0 End*}
							...
							{*  2020-10-26 Myo Min Kyaw Remove Add Ticket MSCRM Ver 1.0 Start*}
							{if ($IS_SELECT_BUTTON || $IS_CREATE_PERMITTED) && ($RELATED_MODULE_NAME neq "PurchaseOrder")}
							{*  2020-10-26 Myo Min Kyaw Remove Add Ticket MSCRM Ver 1.0 End*}
