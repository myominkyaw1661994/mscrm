								...
								<ul class="dropdown-menu" role="menu" aria-labelledby="dropdownMenu1" style="width:500px;">
									...
									<li id="quickCreateModules" style="padding: 0 5px;">
										<div class="col-lg-12" style="padding-bottom:15px;">
											...
											{*2020-12-10 Thet Phyo Wai Quick Create Hide Ticket and Customer Product Link MSCRM Start*}
											{if $moduleName eq 'HelpDesk' or $moduleName eq 'ContactProduct'}
											{continue}
											{/if}
											{*2020-12-10 Thet Phyo Wai Quick Create Hide Ticket and Customer Product Link MSCRM End*}
