	...
	registerInlineEdit: function (currentTrElement) {
		...
		for (var i = 0; i < tdElements.length; i++) {
			...
			if (typeof uimeta !== "undefined") {
				...
				/*28-06-2021 Myo Min Kyaw Show Correct Currency at the cusotmer product link start*/
				var value = tdElement[0].innerText
				var currencySymbol = null;
				if(fieldName ==  "contract_price" && moduleName == "ContactProduct"){
					var threeCharacter = value.substring(0, 3);
					var oneCharacter = value.substring(0, 1);
					var twoCharater = value.substring(0, 2);

					if(twoCharater == "S$"){
						currencySymbol = "S$"
					}else if(threeCharacter == "MMK"){
						currencySymbol = "MMK"
				...
				fieldBasicInfo.currency_symbol = currencySymbol
				/*28-06-2021 Myo Min Kyaw Show Correct Currency at the cusotmer product link end*/
