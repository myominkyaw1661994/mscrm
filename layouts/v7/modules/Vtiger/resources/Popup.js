...
jQuery.Class("Vtiger_Popup_Js",{
	...
	getCompleteParams : function(){
		...
		/*2020-09-30 Thet Phyo Wai Ticket Module Update MSCRM Ver 1.0 start*/
		//UPDATE START
		if(this.getSourceModule() == 'HelpDesk' || this.getSourceModule() == 'Invoice'){
			if(app.view() == 'Edit'){
				var form = jQuery('[name="editContent"]');
		...
		//UPDATE END
		/*2020-09-30 Thet Phyo Wai Ticket Module Update MSCRM Ver 1.0 End*/
    ...
    getListViewEntries: function(e){
		...
		if(typeof dataUrl != 'undefined'){
			...
			if(parentModule == "HelpDesk" || parentModule == "Invoice" || parentModule == "ContactProduct"){
				dataUrl = dataUrl+'&parentModule='+parentModule;
			}
			/*2020/09/22 Thet Phyo Wai Add Field Ticket Ver 1.0 End*/
