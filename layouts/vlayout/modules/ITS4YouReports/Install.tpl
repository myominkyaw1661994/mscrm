...
<div id="step2" class="padding1per" style="border:1px solid #ccc;  {if $STEP neq "2"}display:none;{/if}">
    ...
    <div class="">
        ...
        <br>
        <div>
            {vtranslate('LBL_MORE_INFORMATION',$MODULE)}&nbsp;
            <a href="https://it-solutions4you.com/tipstricks/vtiger-system-requirements/" target="_blank">
                {vtranslate('LBL_SYSTEM_REQUIREMENTS',$MODULE)} https://it-solutions4you.com/tipstricks/vtiger-system-requirements/
            </a>
        </div>
        <br>
        <div class="clearfix">
    ...
    <div class="">
        <button type="button" id="download_button" class="btn btn-success" /><strong>{vtranslate('LBL_DOWNLOAD','ITS4YouReports')}</strong></button>&nbsp;&nbsp;
        <button type="button" id="finish_button" class="btn btn-success hide" onclick="location.reload(true);"/><strong>{vtranslate('LBL_FINISH','ITS4YouReports')}</strong></button>&nbsp;&nbsp;
    </div>
</div>
