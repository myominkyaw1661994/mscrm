...
{* //ITS4YOU-END *}
    ...
    <tr>
        <td class="fieldLabel medium"><label class="pull-right marginRight10px">{vtranslate('LBL_REPORT_CSV_PATH',$MODULE)}</label></td>
        <td>
            <input type="text" class="inputElement" data-rule-required="false" name="csv_path" id="csv_path"
                   placeholder="/test/ITS4YouReports/" value="{$CSV_PATH}"/>
        </td>
    </tr>
	<tr>
