                        ...
                        <td>
                            {if $LINK_DATA.mapped eq 0}
                                <a href='index.php?module=ITS4YouFieldMapping&parent=Settings&view=EditLink&recordId={$RECORDID}&linkId={$LINK_DATA.linkid}'>
                                    <i title="{vtranslate('LBL_EDIT', $MODULE)}" style="vertical-align: top;" class="icon-pencil alignMiddle"></i>
                                </a>
                                &nbsp;&nbsp;&nbsp;
                                <a class="deleteLink">
                                    <i class="icon-trash" title="{vtranslate('LBL_DELETE', $MODULE)}"></i>
                                </a>
                                &nbsp;&nbsp;&nbsp;
                                {if $LINK_DATA.convert eq true}
                                    <a class="relationAdd">
                                        <i title="{vtranslate('LBL_CONVERT_LINK', $QUALIFIED_MODULE)}" class="icon-plus"></i>
                                    </a>
                                {/if}
                            {else}
