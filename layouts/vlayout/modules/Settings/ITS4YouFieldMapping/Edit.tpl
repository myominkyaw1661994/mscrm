    ...
    <div class="container-fluid editViewContainer">
        ...
        <form id="EditView" class="form-horizontal recordEditView" enctype="multipart/form-data" action="index.php" method="post" name="EditView">
            ...
            <table class="table table-bordered blockContainer showInlineTable">
                <tbody>
                <tr>
                    <th class="blockHeader" colspan="4">{vtranslate('LBL_REL_DETAIL',$QUALIFIED_MODULE)}</th>
                </tr>
                <tr>
                    ...
                    <td class="fieldValue medium">
                        <div class="row-fluid">
                                <span class="span10">
                                    <input class="input-large nameField" type="text" name="Name">
                                </span>
                        </div>
                    </td>
                    <td class="fieldLabel medium">
                ...
                <tr>
                    ...
                    <td class="fieldValue medium">
                        <div class="row-fluid">
                                <span class="span10">
                                    <select name="sourceModule" class="chzn-select">
                    ...
                    <td class="fieldValue medium">
                        <div class="row-fluid">
                                <span class="span10">
                                    <select name="targetModule" class="chzn-select">
                                        {foreach item=MODULE_MODEL key=MODULE_ID from=$ENTITY_MODULES}
                                            {assign var=MODULE_NAME value=$MODULE_MODEL->get('name')}
                                            <option value="{$MODULE_ID}">{vtranslate($MODULE_NAME, $MODULE_NAME)}</option>
                                        {/foreach}
                ...
                <tr>
                    ...
                    <td class="fieldValue medium">
                        <div class="row-fluid">
                                <span class="span10">
                                    <textarea class="row-fluid " type="" name="Description"></textarea>
                                </span>
                        </div>
                    </td>
                    <td class="fieldLabel medium">
