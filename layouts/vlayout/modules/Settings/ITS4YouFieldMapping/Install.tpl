...
-->*}
{strip}
    <div class="editContainer container" style="padding-left: 2%;padding-right: 2%">
        ...
        <div class="installationContents">
            <div style="border:1px solid #ccc;padding:1%;{if $STEP neq "1"}display:none;{/if}" id="stepContent1">
                <form name="install" id="editLicense" method="POST" action="index.php" class="form-horizontal container-fluid">
            ...
            <div style="border:1px solid #ccc;padding:1%;{if $STEP neq "4"}display:none;{/if}" id="stepContent2">
                <div class="row container-fluid">
                    <div class="col-sm-12 col-md-12 col-lg-12">
                        ...
                        <div class="controls">
                            <button type="submit" id="next_button" class="btn btn-success"/>
                            <strong>{vtranslate('LBL_FINISH',$QUALIFIED_MODULE)}</strong></button>&nbsp;&nbsp;
                        </div>
                    </div>
                </div>
            </div>
    ...
    <script language="javascript" type="text/javascript">
        jQuery(document).ready(function () {
            var thisInstance = ITS4YouFieldMapping_License_Js.getInstance();
