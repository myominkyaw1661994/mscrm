...
class Events_Module_Model extends Calendar_Module_Model {
   ...
   /**
	...
	public function saveRecord(Vtiger_Record_Model $recordModel) {
		...
		/* 28-12-2020 Myo Min Kyaw Send Email when event is create or delete MSCRM Ver 1.0 start*/
		$deleteUser = vglobal('de');
		$oldUser = vglobal('ol');
		/* 28-12-2020 Myo Min Kyaw Send Email when event is create or delete MSCRM Ver 1.0 end*/

        if(!empty($selectUsers) || $deleteUser || $oldUser)
        {
