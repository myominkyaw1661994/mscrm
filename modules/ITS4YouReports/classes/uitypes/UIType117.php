...
class UIType117 extends UITypes {
    ...
    public function getJoinSQL(&$join_array, &$columns_array) {
        ...
        $currency_info_col_sql = " vtiger_currency_info" . $fieldid_alias . ".currency_name AS currency_name" . $fieldid_alias . " ";
        $columns_array[] = $currency_info_col_sql;
        $columns_array[$this->params["fld_string"]]["fld_alias"] = "currency_name" . $fieldid_alias;
        $columns_array[$this->params["fld_string"]]["fld_sql_str"] = $currency_info_col_sql;
        $columns_array[$this->params["fld_string"]]["fld_cond"] = "vtiger_currency_info" . $fieldid_alias . ".currency_name";
        $columns_array["currency_name" . $fieldid_alias] = $this->params["field_uitype"];
        $columns_array["currency_name" . $fieldid_alias] = $this->params["fld_string"];
    }
