...
class UITypeINV extends UITypes {
    ...
    public function getInventoryJoinSQL(&$join_array, &$columns_array) {
        ...
        if (!array_key_exists(" vtiger_productcf AS vtiger_productcf_inv" . $fieldid_alias . " ", $join_array)) {
        ...
        if (!array_key_exists(" vtiger_crmentity AS vtiger_crmentity_service_inv" . $fieldid_alias . " ", $join_array)) {
        ...
        if (!array_key_exists(" vtiger_servicecf AS vtiger_servicecf_inv" . $fieldid_alias . " ", $join_array)) {
        ...
        if ($this->params["columnname"] != "" && !in_array($this->params["columnname"], ITS4YouReports::$intentory_fields)) {
            ...
            if ($column_tablename == "vtiger_crmentity") {
                $old_oth_fieldid = '_inv';
                $old_oth_fieldid_as = '_' . $old_oth_fieldid;
                $column_tablename_as = $column_tablename . $old_oth_fieldid_as;
            } elseif (in_array($this->params["fieldmodule"], ['Products', 'Service',])) {
                $old_oth_fieldid = 'inv';
                $old_oth_fieldid_as = $old_oth_fieldid;
                $column_tablename_as = $column_tablename . $old_oth_fieldid_as;
            } else {
                $old_oth_fieldid = 'inv';
                $old_oth_fieldid_as = '_' . $old_oth_fieldid;
