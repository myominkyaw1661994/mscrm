...
Class Inventory_Edit_View extends Vtiger_Edit_View {
	...
	public function process(Vtiger_Request $request) {
		...
		/*2020-11-17 Thet Phyo Wai Limit Decimal Number MSCRM Start*/
		$currentUserModel = Users_Record_Model::getCurrentUserModel();
		$numOfCurrencyDecimals = $currentUserModel->get('no_of_currency_decimals');
		foreach ($relatedProducts as $key=>$value){
			$relatedProducts[$key]['purchaseCost'.$key] = number_format($relatedProducts[$key]['purchaseCost'.$key], $numOfCurrencyDecimals, '.', '');
			$relatedProducts[$key]['listPrice'.$key] = number_format($relatedProducts[$key]['listPrice'.$key], $numOfCurrencyDecimals, '.', '');
		}
		/*2020-11-17 Thet Phyo Wai Limit Decimal Number MSCRM End*/
		...
		/*2020-09-23 Thet Phyo Wai Customize Invoice Module MSCRM Ver 1.0 Start*/
		/*if($isRelationOperation) {*/
		if($isRelationOperation || ($sourceModule=='HelpDesk' && $moduleName=='Invoice') ) {
		/*2020-09-23 Thet Phyo Wai Customize Invoice Module MSCRM Ver 1.0 End*/
		...
		// 2020/09/16 Pyae Phyo Mon Permission of PDF Output MSCRM Ver 1.0 start
		...
		// 2020/09/16 Pyae Phyo Mon Permission of PDF Output MSCRM Ver 1.0 end
