...
class PDFMaker_UninstallPDFMaker_Action extends Settings_Vtiger_Basic_Action
{
    ...
    public function process(Vtiger_Request $request)
    {
        ...
        if ($module) {
            ...
            @shell_exec('rm -r layouts/v7/modules/PDFMaker');
            @shell_exec('rm -f languages/ar_ae/PDFMaker.php');
            ...
            @shell_exec('rm -f languages/es_co/PDFMaker.php');
            @shell_exec('rm -f languages/es_es/PDFMaker.php');
            @shell_exec('rm -f languages/es_mx/PDFMaker.php');
            @shell_exec('rm -f languages/es_ve/PDFMaker.php');
            @shell_exec('rm -f languages/fi_fi/PDFMaker.php');
