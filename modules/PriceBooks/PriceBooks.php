...
class PriceBooks extends CRMEntity {
	...
	function importRecord($obj, $fieldData, $productList) {
		...
		/*2021-01-14 Myo Min Kyaw Import and export result not show MSCRM Ver 1.0 Start */
		//$entityInfo['status'] = $obj->getImportRecordStatus('created');
		/*2021-01-14 Myo Min Kyaw Import and export result not show MSCRM Ver 1.0 end */
		return $entityInfo;
	}
