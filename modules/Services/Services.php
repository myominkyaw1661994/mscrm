...
class Services extends CRMEntity {
	...
	{
		/*2020-11-06 Pyae Phyo Mon Service Purchase Cost Currency Change Start*/
		...
		if(!($_REQUEST['purchase_cost'] == 0 || $_REQUEST['purchase_cost'] == '' || $_REQUEST['purchase_cost'] == null)){
			...
			$adb->pquery("UPDATE vtiger_service SET purchase_cost=? WHERE serviceid=?", array($purchaseCost,$serviceid));
