...
class Vtiger_Currency_UIType extends Vtiger_Base_UIType {
	 ...
	 */
	//2021-05-17 Myo Min Kyaw  Change the Data type for contract price in Customer Product link(add new parameter $skipFormatting) MSCRM var 1.0 Start-
	public static function transformDisplayValue($value, $user=null, $skipConversion=false, $skipFormatting=false) {
		return CurrencyField::convertToUserFormat($value, $user, $skipConversion, $skipFormatting);
	//2021-05-17 Myo Min Kyaw  Change the Data type for contract price in Customer Product link(add new parameter $skipFormatting) MSCRM var 1.0 End-	
	}
