...
class Vtiger_Popup_View extends Vtiger_Footer_View {
	...
	public function initializeListViewContents(Vtiger_Request $request, Vtiger_Viewer $viewer) {
		...
		if(!empty($relatedParentModule) && !empty($relatedParentId)) {
			...
			//UPDATE START
			if($sourceModule === "HelpDesk" || $sourceModule === "Invoice"){
				$relatedParentModule = $request->get('related_parent_module');
				$listViewModel->set('relatedContactId',$request->get('related_contact_id'));
				$listViewModel->set('relatedAccountId',$request->get('related_account_id'));
				if( $relatedParentModule == 'ContactProduct'){
					$listViewModel->set('relatedProductId',$request->get('related_product_id'));
				}
			}
			//UPDATE END
