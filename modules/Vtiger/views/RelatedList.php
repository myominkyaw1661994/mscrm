...
class Vtiger_RelatedList_View extends Vtiger_Index_View {
	...
	function process(Vtiger_Request $request) {
		...
		/*2020-12-14 Thet Phyo Wai Hide Edit and Unlink Ticket MSCRM Start*/
		if(($moduleName == 'Products' || $moduleName == 'Accounts' || $moduleName == 'Contacts' || $moduleName == 'Services') && $relatedModuleName == 'HelpDesk'){
			$viewer->assign('IS_EDITABLE', false);
			$viewer->assign('IS_DELETABLE', false);
		}
		/*2020-12-14 Thet Phyo Wai Hide Edit and Unlink Ticket MSCRM End*/
