<?php /* Smarty version Smarty-3.1.7, created on 2022-01-24 09:50:30
         compiled from "E:\xampp\htdocs\CSC0tester\includes\runtime/../../layouts/v7\modules\Vtiger\uitypes\StringDetailView.tpl" */ ?>
<?php /*%%SmartyHeaderCode:193334459261ee1afec29b80-83196658%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '0fe4ffbea21b99aacb5b002f02092c8b692a60c1' => 
    array (
      0 => 'E:\\xampp\\htdocs\\CSC0tester\\includes\\runtime/../../layouts/v7\\modules\\Vtiger\\uitypes\\StringDetailView.tpl',
      1 => 1605175362,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '193334459261ee1afec29b80-83196658',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_61ee1afeea9f2',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_61ee1afeea9f2')) {function content_61ee1afeea9f2($_smarty_tpl) {?>
...
<?php }elseif($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->getFieldDataType()=='currency'){?>
    ...
    <?php }elseif($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->get('uitype')=='71'){?>
        ...
        <?php if ($_smarty_tpl->tpl_vars['MODULE']->value=='ContactProduct'||$_smarty_tpl->tpl_vars['MODULE']->value=='Products'||$_smarty_tpl->tpl_vars['MODULE']->value=='Services'){?>
          <?php ob_start();?><?php echo $_smarty_tpl->tpl_vars['RECORD']->value->get('currency');?>
<?php $_tmp1=ob_get_clean();?><?php $_smarty_tpl->tpl_vars['CURRENCY_INFO'] = new Smarty_variable(getCurrencySymbolandCRate($_tmp1), null, 0);?>
          <?php $_smarty_tpl->tpl_vars['CURRENCY_INFO2'] = new Smarty_variable(getCurrencySymbolandCRate($_smarty_tpl->tpl_vars['CURRENT_USER_MODEL']->value->get('currency_id')), null, 0);?>
          
          <?php if ($_smarty_tpl->tpl_vars['MODULE']->value=='Products'||$_smarty_tpl->tpl_vars['MODULE']->value=='Services'){?>
            <?php $_smarty_tpl->tpl_vars['FIELD_VALUE'] = new Smarty_variable(($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->get('fieldvalue')/$_smarty_tpl->tpl_vars['CURRENCY_INFO2']->value['rate']), null, 0);?>
          <?php }?>
...
&nbsp;<span class="currencyValue"><?php echo $_smarty_tpl->tpl_vars['FIELD_MODEL']->value->getDisplayValue($_smarty_tpl->tpl_vars['FIELD_VALUE']->value);?>
</span>
