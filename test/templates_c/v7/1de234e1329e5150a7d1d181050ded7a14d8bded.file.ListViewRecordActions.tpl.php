<?php /* Smarty version Smarty-3.1.7, created on 2020-10-30 10:34:06
         compiled from "F:\Project\MSCRM_Rehearsal_2\includes\runtime/../../layouts/v7\modules\Vtiger\ListViewRecordActions.tpl" */ ?>
<?php /*%%SmartyHeaderCode:15761165525f9bec1e525c97-04794701%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '1de234e1329e5150a7d1d181050ded7a14d8bded' => 
    array (
      0 => 'F:\\Project\\MSCRM_Rehearsal_2\\includes\\runtime/../../layouts/v7\\modules\\Vtiger\\ListViewRecordActions.tpl',
      1 => 1603363888,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '15761165525f9bec1e525c97-04794701',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5f9bec1e634fe',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5f9bec1e634fe')) {function content_5f9bec1e634fe($_smarty_tpl) {?>
...
</a></li><?php if ($_smarty_tpl->tpl_vars['RECORD_ACTIONS']->value){?><?php if ($_smarty_tpl->tpl_vars['RECORD_ACTIONS']->value['edit']&&!($_smarty_tpl->tpl_vars['IS_EDIT']->value&&(($_smarty_tpl->tpl_vars['MODULE']->value=='HelpDesk'&&$_smarty_tpl->tpl_vars['LISTVIEW_ENTRY']->value->get('ticketstatus')=='Closed')||($_smarty_tpl->tpl_vars['MODULE']->value=='PurchaseOrder'&&$_smarty_tpl->tpl_vars['LISTVIEW_ENTRY']->value->get('approve')=='Yes')||($_smarty_tpl->tpl_vars['MODULE']->value=='Invoice'&&$_smarty_tpl->tpl_vars['LISTVIEW_ENTRY']->value->get('invoicestatus')=='Paid')))){?><li><a data-id="<?php echo $_smarty_tpl->tpl_vars['LISTVIEW_ENTRY']->value->getId();?>
