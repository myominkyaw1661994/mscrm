<?php /* Smarty version Smarty-3.1.7, created on 2020-10-30 10:34:37
         compiled from "F:\Project\MSCRM_Rehearsal_2\includes\runtime/../../layouts/v7\modules\Vtiger\SummaryViewContents.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1835403825f9bec3d3b8299-02716140%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '5181d9f294bc497f74f18031f94fe19f7ac917f2' => 
    array (
      0 => 'F:\\Project\\MSCRM_Rehearsal_2\\includes\\runtime/../../layouts/v7\\modules\\Vtiger\\SummaryViewContents.tpl',
      1 => 1603363888,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1835403825f9bec3d3b8299-02716140',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5f9bec3d406d8',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5f9bec3d406d8')) {function content_5f9bec3d406d8($_smarty_tpl) {?>
...
</span><?php if ($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->isEditable()=='true'&&$_smarty_tpl->tpl_vars['IS_AJAX_ENABLED']->value&&$_smarty_tpl->tpl_vars['FIELD_MODEL']->value->isAjaxEditable()=='true'&&$_smarty_tpl->tpl_vars['FIELD_MODEL']->value->get('uitype')!=69){?><?php if (!($_smarty_tpl->tpl_vars['IS_EDIT']->value)){?><span class="hide edit"><?php if ($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->getFieldDataType()=='multipicklist'){?><input type="hidden" class="fieldBasicData" data-name='<?php echo $_smarty_tpl->tpl_vars['FIELD_MODEL']->value->get('name');?>
