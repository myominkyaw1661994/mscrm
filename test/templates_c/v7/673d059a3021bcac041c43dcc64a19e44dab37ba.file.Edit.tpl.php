<?php /* Smarty version Smarty-3.1.7, created on 2020-10-30 11:07:09
         compiled from "F:\Project\MSCRM_Rehearsal_2\includes\runtime/../../layouts/v7\modules\PDFMaker\Edit.tpl" */ ?>
<?php /*%%SmartyHeaderCode:4393328805f9bf3ddae8360-86972304%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '673d059a3021bcac041c43dcc64a19e44dab37ba' => 
    array (
      0 => 'F:\\Project\\MSCRM_Rehearsal_2\\includes\\runtime/../../layouts/v7\\modules\\PDFMaker\\Edit.tpl',
      1 => 1601907276,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '4393328805f9bf3ddae8360-86972304',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5f9bf3ddc832a',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5f9bf3ddc832a')) {function content_5f9bf3ddc832a($_smarty_tpl) {?><?php if (!is_callable('smarty_function_html_options')) include 'F:\\Project\\MSCRM_Rehearsal_2\\libraries\\Smarty\\libs\\plugins\\function.html_options.php';
?>
<div class="contents tabbable ui-sortable" style="margin-bottom: 70px;"><form class="form-horizontal recordEditView" id="EditView" name="EditView" method="post" action="index.php" enctype="multipart/form-data"><input type="hidden" name="module" value="PDFMaker"><input type="hidden" name="parenttab" value="<?php echo $_smarty_tpl->tpl_vars['PARENTTAB']->value;?>
...
"></i></button><a href="index.php?module=PDFMaker&view=IndexAjax&mode=getAwesomeInfoPDF" target="_new"><button type="button" class="btn"><i class="fa fa-info"></i></button></a></div></div></div></div><div class="form-group"><label class="control-label fieldLabel col-sm-3" style="font-weight: normal"><?php echo vtranslate('LBL_IS_SIGNATURE',$_smarty_tpl->tpl_vars['MODULE']->value);?>
:</label><div class="controls col-sm-9"><div class="input-group"><select name="signaturevalues" id="signaturevalues" class="select2 form-control"><option value="PDF_SIGNATURE"><?php echo vtranslate('PDF_SIGNATURE',$_smarty_tpl->tpl_vars['MODULE']->value);?>
</option></select><div class="input-group-btn"><button type="button" class="btn btn-success InsertIntoTemplate" data-type="signaturevalues" title="<?php echo vtranslate('LBL_INSERT_TO_TEXT',$_smarty_tpl->tpl_vars['MODULE']->value);?>
"><i class="fa fa-usd"></i></button></div></div></div></div></div></div><div class="tab-pane" id="pdfContentLabels"><div class="edit-template-content col-lg-4" style="position:fixed;z-index:1000;"><br /><div class="form-group" id="labels_div"><label class="control-label fieldLabel col-sm-3" style="font-weight: normal"><?php echo vtranslate('LBL_GLOBAL_LANG',$_smarty_tpl->tpl_vars['MODULE']->value);?>
...
" style="width:<?php echo $_smarty_tpl->tpl_vars['margin_input_width']->value;?>
"/></td></tr></table></div></div><div class="form-group"><label class="control-label fieldLabel col-sm-3" style="font-weight: normal"><?php echo vtranslate('LBL_CURRENCY_FORMAT',$_smarty_tpl->tpl_vars['MODULE']->value);?>
:</label><div class="controls col-sm-9"><table class="table table-bordered"><tr><td align="right" nowrap><?php echo vtranslate('LBL_CURRENCY_ACTIVE',$_smarty_tpl->tpl_vars['MODULE']->value);?>
</td><td><input type="checkbox" maxlength="2" name="is_currency" <?php if ($_smarty_tpl->tpl_vars['PDF_TEMPLATE_RESULT']->value['is_currency']){?>checked<?php }?>></td></tr><tr><td align="right" nowrap><?php echo vtranslate('LBL_CURRENCY_POINT',$_smarty_tpl->tpl_vars['MODULE']->value);?>
</td><td><input type="text" maxlength="2" name="currency_point" class="inputElement" value="<?php echo $_smarty_tpl->tpl_vars['PDF_TEMPLATE_RESULT']->value['currency_point'];?>
" style="width:<?php echo $_smarty_tpl->tpl_vars['margin_input_width']->value;?>
"/></td></tr><tr><td align="right" nowrap><?php echo vtranslate('LBL_CURRENCY_DECIMALS',$_smarty_tpl->tpl_vars['MODULE']->value);?>
</td><td><input type="text" maxlength="2" name="currency" class="inputElement" value="<?php echo $_smarty_tpl->tpl_vars['PDF_TEMPLATE_RESULT']->value['currency'];?>
" style="width:<?php echo $_smarty_tpl->tpl_vars['margin_input_width']->value;?>
"/></td></tr><tr><td align="right" nowrap><?php echo vtranslate('LBL_DEC_THOUSANDS',$_smarty_tpl->tpl_vars['MODULE']->value);?>
</td><td><input type="text" maxlength="2" name="currency_thousands" class="inputElement" value="<?php echo $_smarty_tpl->tpl_vars['PDF_TEMPLATE_RESULT']->value['currency_thousands'];?>
" style="width:<?php echo $_smarty_tpl->tpl_vars['margin_input_width']->value;?>
...
:</label><div class="controls col-sm-9"><input type="checkbox" id="is_portal" name="is_portal" <?php echo $_smarty_tpl->tpl_vars['IS_PORTAL_CHECKED']->value;?>
 onclick="return PDFMaker_EditJs.ConfirmIsPortal(this);"/></div></div><div class="form-group"><label class="control-label fieldLabel col-sm-3" style="font-weight: normal"><?php echo vtranslate('LBL_SIGNATURE',$_smarty_tpl->tpl_vars['MODULE']->value);?>
:</label><div class="controls col-sm-9"><table class="table table-bordered"><tr><td align="right"><?php echo vtranslate('LBL_WIDTH_PX',$_smarty_tpl->tpl_vars['MODULE']->value);?>
</td><td><input type="text" class="inputElement" name="signature_width" value="<?php echo $_smarty_tpl->tpl_vars['SIGNATURE_WIDTH']->value;?>
"></td></tr><tr><td align="right"><?php echo vtranslate('LBL_HEIGHT_PX',$_smarty_tpl->tpl_vars['MODULE']->value);?>
</td><td><input type="text" class="inputElement" name="signature_height" value="<?php echo $_smarty_tpl->tpl_vars['SIGNATURE_HEIGHT']->value;?>
"></td></tr></table></div></div><div class="form-group"><label class="control-label fieldLabel col-sm-3" style="font-weight: normal"><?php echo vtranslate('LBL_DEFAULT_PRODUCT_IMAGE',$_smarty_tpl->tpl_vars['MODULE']->value);?>
:</label><div class="controls col-sm-9"><table class="table table-bordered"><tr><td align="right"><?php echo vtranslate('LBL_WIDTH_PX',$_smarty_tpl->tpl_vars['MODULE']->value);?>
</td><td><input type="text" name="product_image_width" class="inputElement" value="<?php echo $_smarty_tpl->tpl_vars['PDF_TEMPLATE_RESULT']->value['product_image_width'];?>
"></td></tr><tr><td align="right"><?php echo vtranslate('LBL_HEIGHT_PX',$_smarty_tpl->tpl_vars['MODULE']->value);?>
</td><td><input type="text" name="product_image_height" class="inputElement" value="<?php echo $_smarty_tpl->tpl_vars['PDF_TEMPLATE_RESULT']->value['product_image_height'];?>
"></td></tr></table></div></div></div></div><div class="tab-pane" id="editTabSharing"><br><div id="sharing_div"><div class="form-group"><label class="control-label fieldLabel col-sm-3" style="font-weight: normal"><?php echo vtranslate('LBL_TEMPLATE_OWNER',$_smarty_tpl->tpl_vars['MODULE']->value);?>
...
Output" class="cm-s-default"></td></tr></tbody></table><br><?php } ?></div><?php }?><?php }?></div><div class="hide"><textarea id="fontawesomeclass"><?php echo $_smarty_tpl->tpl_vars['FONTAWESOMECLASS']->value;?>
                                    ...
                                    <?php }?>})</script></div></div></div></div></div><div class="modal-overlay-footer row-fluid"><div class="textAlignCenter "><button class="btn" type="submit" onclick="document.EditView.redirect.value = 'false';" ><strong><?php echo vtranslate('LBL_APPLY',$_smarty_tpl->tpl_vars['MODULE']->value);?>
