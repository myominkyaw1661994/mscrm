<?php /* Smarty version Smarty-3.1.7, created on 2022-01-25 14:09:04
         compiled from "E:\xampp\htdocs\CSC0tester\includes\runtime/../../layouts/v7\modules\Inventory\LineItemsDetail.tpl" */ ?>
<?php /*%%SmartyHeaderCode:106453012061efa918315657-91786688%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '6e22927d26732f48100dd711ad51ff3c90b3d213' => 
    array (
      0 => 'E:\\xampp\\htdocs\\CSC0tester\\includes\\runtime/../../layouts/v7\\modules\\Inventory\\LineItemsDetail.tpl',
      1 => 1603088812,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '106453012061efa918315657-91786688',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_61efa918b70f6',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_61efa918b70f6')) {function content_61efa918b70f6($_smarty_tpl) {?>
...
<?php $_tmp8=ob_get_clean();?><?php ob_start();?><?php  $_smarty_tpl->tpl_vars['tax_details'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['tax_details']->_loop = false;
...
?><?php if ($_smarty_tpl->tpl_vars['FINAL_DETAILS']->value['taxes'][$_smarty_tpl->tpl_vars['COMPOUND_TAX_ID']->value]['taxlabel']){?><?php echo " + ";?><?php echo $_smarty_tpl->tpl_vars['FINAL_DETAILS']->value['taxes'][$_smarty_tpl->tpl_vars['COMPOUND_TAX_ID']->value]['taxlabel'];?><?php }?><?php } ?><?php echo ")";?><?php }?><?php echo " = ";?><?php echo $_smarty_tpl->tpl_vars['tax_details']->value['amount'];?><?php echo "<br />";?><?php }?><?php } ?><?php $_tmp9=ob_get_clean();?><?php ob_start();?><?php echo vtranslate('LBL_TOTAL_TAX_AMOUNT',$_smarty_tpl->tpl_vars['MODULE_NAME']->value);?>
<?php $_tmp10=ob_get_clean();?><?php $_smarty_tpl->tpl_vars['INDIVIDUAL_TAX_INFO'] = new Smarty_variable($_tmp8." = ".($_smarty_tpl->tpl_vars['LINE_ITEM_DETAIL']->value["totalAfterDiscount".($_smarty_tpl->tpl_vars['INDEX']->value)])."<br /><br />".$_tmp9."<br /><br />".$_tmp10." = ".($_smarty_tpl->tpl_vars['LINE_ITEM_DETAIL']->value["taxTotal".($_smarty_tpl->tpl_vars['INDEX']->value)]), null, 0);?>
...
<?php $_tmp11=ob_get_clean();?><?php ob_start();?><?php if ($_smarty_tpl->tpl_vars['DISCOUNT_PERCENT_VIEWABLE']->value&&$_smarty_tpl->tpl_vars['FINAL_DETAILS']->value['discount_type_final']=='percentage'){?><?php echo " ";?><?php echo $_smarty_tpl->tpl_vars['FINAL_DETAILS']->value['discount_percentage_final'];?><?php echo "	% ";?><?php echo vtranslate('LBL_OF',$_smarty_tpl->tpl_vars['MODULE_NAME']->value);?>
<?php echo " ";?><?php echo $_smarty_tpl->tpl_vars['FINAL_DETAILS']->value['hdnSubTotal'];?><?php echo " = ";?><?php }?><?php $_tmp12=ob_get_clean();?><?php $_smarty_tpl->tpl_vars['FINAL_DISCOUNT_INFO'] = new Smarty_variable($_tmp11." = ".$_tmp12.($_smarty_tpl->tpl_vars['FINAL_DETAILS']->value['discountTotal_final']), null, 0);?>
        ...
        <?php if ($_smarty_tpl->tpl_vars['SH_PERCENT_VIEWABLE']->value){?>
            <tr>
                <td width="83%">
                    <div align="right">
                        <?php ob_start();?><?php echo vtranslate('LBL_TOTAL_AFTER_DISCOUNT',$_smarty_tpl->tpl_vars['MODULE_NAME']->value);?>
<?php $_tmp13=ob_get_clean();?><?php ob_start();?><?php  $_smarty_tpl->tpl_vars['CHARGE_INFO'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['CHARGE_INFO']->_loop = false;
...
<?php echo " ";?><?php echo $_smarty_tpl->tpl_vars['FINAL_DETAILS']->value['totalAfterDiscount'];?><?php }?><?php echo " = ";?><?php echo $_smarty_tpl->tpl_vars['CHARGE_INFO']->value['amount'];?><?php echo "<br />";?><?php } ?><?php $_tmp14=ob_get_clean();?><?php ob_start();?><?php echo vtranslate('LBL_CHARGES_TOTAL',$_smarty_tpl->tpl_vars['MODULE_NAME']->value);?>
<?php $_tmp15=ob_get_clean();?><?php $_smarty_tpl->tpl_vars['CHARGES_INFO'] = new Smarty_variable($_tmp13." = ".($_smarty_tpl->tpl_vars['FINAL_DETAILS']->value['totalAfterDiscount'])."<br /><br />".$_tmp14."<br /><h5>".$_tmp15." = ".($_smarty_tpl->tpl_vars['FINAL_DETAILS']->value['shipping_handling_charge'])."</h5>", null, 0);?>
        ...
        <?php if ($_smarty_tpl->tpl_vars['FINAL_DETAILS']->value['taxtype']=='group'){?>
            <tr>
                <td width="83%">
                    <div align="right">
                        <?php ob_start();?><?php echo vtranslate('LBL_TOTAL_AFTER_DISCOUNT',$_smarty_tpl->tpl_vars['MODULE_NAME']->value);?>
<?php $_tmp16=ob_get_clean();?><?php ob_start();?><?php  $_smarty_tpl->tpl_vars['tax_details'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['tax_details']->_loop = false;
...
foreach ($_from as $_smarty_tpl->tpl_vars['COMPOUND_TAX_ID']->key => $_smarty_tpl->tpl_vars['COMPOUND_TAX_ID']->value){
$_smarty_tpl->tpl_vars['COMPOUND_TAX_ID']->_loop = true;
?><?php if ($_smarty_tpl->tpl_vars['FINAL_DETAILS']->value['taxes'][$_smarty_tpl->tpl_vars['COMPOUND_TAX_ID']->value]['taxlabel']){?><?php echo " + ";?><?php echo $_smarty_tpl->tpl_vars['FINAL_DETAILS']->value['taxes'][$_smarty_tpl->tpl_vars['COMPOUND_TAX_ID']->value]['taxlabel'];?><?php }?><?php } ?><?php echo ")";?><?php }?><?php echo " = ";?><?php echo $_smarty_tpl->tpl_vars['tax_details']->value['amount'];?><?php echo "<br />";?><?php } ?><?php $_tmp17=ob_get_clean();?><?php ob_start();?><?php echo vtranslate('LBL_TOTAL_TAX_AMOUNT',$_smarty_tpl->tpl_vars['MODULE_NAME']->value);?>
<?php $_tmp18=ob_get_clean();?><?php $_smarty_tpl->tpl_vars['GROUP_TAX_INFO'] = new Smarty_variable($_tmp16." = ".($_smarty_tpl->tpl_vars['FINAL_DETAILS']->value['totalAfterDiscount'])."<br /><br />".$_tmp17."<br />".$_tmp18." = ".($_smarty_tpl->tpl_vars['FINAL_DETAILS']->value['tax_totalamount']), null, 0);?>
...
<?php $_tmp19=ob_get_clean();?><?php ob_start();?><?php  $_smarty_tpl->tpl_vars['CHARGE_INFO'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['CHARGE_INFO']->_loop = false;
 $_smarty_tpl->tpl_vars['CHARGE_ID'] = new Smarty_Variable;
 $_from = $_smarty_tpl->tpl_vars['SELECTED_CHARGES_AND_ITS_TAXES']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['CHARGE_INFO']->key => $_smarty_tpl->tpl_vars['CHARGE_INFO']->value){
$_smarty_tpl->tpl_vars['CHARGE_INFO']->_loop = true;
...
foreach ($_from as $_smarty_tpl->tpl_vars['COMPOUND_TAX_ID']->key => $_smarty_tpl->tpl_vars['COMPOUND_TAX_ID']->value){
$_smarty_tpl->tpl_vars['COMPOUND_TAX_ID']->_loop = true;
?><?php if ($_smarty_tpl->tpl_vars['CHARGE_INFO']->value['taxes'][$_smarty_tpl->tpl_vars['COMPOUND_TAX_ID']->value]['name']){?><?php echo " + ";?><?php echo $_smarty_tpl->tpl_vars['CHARGE_INFO']->value['taxes'][$_smarty_tpl->tpl_vars['COMPOUND_TAX_ID']->value]['name'];?><?php }?><?php } ?><?php echo ")";?><?php }?><?php echo " = ";?><?php echo $_smarty_tpl->tpl_vars['CHARGE_TAX_INFO']->value['amount'];?><?php echo "<br />";?><?php } ?><?php echo "<br />";?><?php }?><?php } ?><?php $_tmp20=ob_get_clean();?><?php ob_start();?><?php echo vtranslate('LBL_TOTAL_TAX_AMOUNT',$_smarty_tpl->tpl_vars['MODULE_NAME']->value);?>
<?php $_tmp21=ob_get_clean();?><?php $_smarty_tpl->tpl_vars['CHARGES_TAX_INFO'] = new Smarty_variable($_tmp19." = ".($_smarty_tpl->tpl_vars['FINAL_DETAILS']->value["shipping_handling_charge"])."<br /><br />".$_tmp20."\r\n".$_tmp21." = ".($_smarty_tpl->tpl_vars['FINAL_DETAILS']->value['shtax_totalamount']), null, 0);?>
