<?php /* Smarty version Smarty-3.1.7, created on 2022-01-25 14:03:17
         compiled from "E:\xampp\htdocs\CSC0tester\includes\runtime/../../layouts/v7\modules\Inventory\partials\LineItemsContent.tpl" */ ?>
<?php /*%%SmartyHeaderCode:106964085761efa7bdba1b49-79153750%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '7f52ac5a64e45bef8e6b58eb931d76636a01f03a' => 
    array (
      0 => 'E:\\xampp\\htdocs\\CSC0tester\\includes\\runtime/../../layouts/v7\\modules\\Inventory\\partials\\LineItemsContent.tpl',
      1 => 1605677008,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '106964085761efa7bdba1b49-79153750',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_61efa7be61c84',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_61efa7be61c84')) {function content_61efa7be61c84($_smarty_tpl) {?>
...
<?php $_tmp1=ob_get_clean();?><?php ob_start();?><?php if ($_smarty_tpl->tpl_vars['data']->value[$_smarty_tpl->tpl_vars['purchaseCost']->value]){?><?php echo (((float)$_smarty_tpl->tpl_vars['data']->value[$_smarty_tpl->tpl_vars['purchaseCost']->value])/((float)$_smarty_tpl->tpl_vars['data']->value[$_smarty_tpl->tpl_vars['qty']->value]*$_tmp1));?><?php }else{ ?><?php echo "0";?><?php }?><?php $_tmp2=ob_get_clean();?><?php $_smarty_tpl->tpl_vars["purchaseCost"] = new Smarty_variable($_tmp2, null, 0);?><?php if ($_smarty_tpl->tpl_vars['purchaseCost']->value==0){?><?php ob_start();?><?php echo $_smarty_tpl->tpl_vars['RECORD_CURRENCY_RATE']->value;?>
<?php $_tmp3=ob_get_clean();?><?php ob_start();?><?php if ($_smarty_tpl->tpl_vars['data']->value[$_smarty_tpl->tpl_vars['listPrice']->value]){?><?php echo (((float)$_smarty_tpl->tpl_vars['data']->value[$_smarty_tpl->tpl_vars['listPrice']->value])/((float)$_smarty_tpl->tpl_vars['data']->value[$_smarty_tpl->tpl_vars['qty']->value]*$_tmp3));?><?php }else{ ?><?php echo "0";?><?php }?><?php $_tmp4=ob_get_clean();?><?php $_smarty_tpl->tpl_vars["purchaseCost"] = new Smarty_variable($_tmp4, null, 0);?><?php }?><?php  $_smarty_tpl->tpl_vars['currency_details'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['currency_details']->_loop = false;
...
" data-module-name="Products" data-field-name="productid"><?php echo Vtiger_Module_Model::getModuleIconPath('Products');?>
</span><?php }?><?php }?></div></div></div></div></div><?php if ($_smarty_tpl->tpl_vars['data']->value[$_smarty_tpl->tpl_vars['productDeleted']->value]){?><div class="row-fluid deletedItem redColor"><?php if (empty($_smarty_tpl->tpl_vars['data']->value[$_smarty_tpl->tpl_vars['productName']->value])){?><?php echo vtranslate('LBL_THIS_LINE_ITEM_IS_DELETED_FROM_THE_SYSTEM_PLEASE_REMOVE_THIS_LINE_ITEM',$_smarty_tpl->tpl_vars['MODULE']->value);?>
...
<?php }else{ ?>0<?php }?>" type="text"data-rule-required=true data-rule-positive=true class="listPrice smallInputBox inputElement" data-is-price-changed="<?php if (($_smarty_tpl->tpl_vars['SOURCE_MODULE']->value=='HelpDesk'||$_smarty_tpl->tpl_vars['RECORD_ID']->value)&&$_smarty_tpl->tpl_vars['row_no']->value!=0){?>true<?php }else{ ?>false<?php }?>" list-info='<?php if (isset($_smarty_tpl->tpl_vars['data']->value[$_smarty_tpl->tpl_vars['listPrice']->value])){?><?php echo Zend_Json::encode($_smarty_tpl->tpl_vars['listPriceValues']->value);?>
<?php }?>' data-base-currency-id="<?php ob_start();?><?php echo $_smarty_tpl->tpl_vars['entityType']->value;?>
<?php $_tmp5=ob_get_clean();?><?php echo getProductBaseCurrency($_smarty_tpl->tpl_vars['productId']->value,$_tmp5);?>
