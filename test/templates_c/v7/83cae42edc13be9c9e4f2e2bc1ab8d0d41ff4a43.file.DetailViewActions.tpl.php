<?php /* Smarty version Smarty-3.1.7, created on 2022-01-25 14:30:57
         compiled from "E:\xampp\htdocs\CSC0tester\includes\runtime/../../layouts/v7\modules\Vtiger\DetailViewActions.tpl" */ ?>
<?php /*%%SmartyHeaderCode:58934342261ee1afe005036-38937155%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '83cae42edc13be9c9e4f2e2bc1ab8d0d41ff4a43' => 
    array (
      0 => 'E:\\xampp\\htdocs\\CSC0tester\\includes\\runtime/../../layouts/v7\\modules\\Vtiger\\DetailViewActions.tpl',
      1 => 1643097440,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '58934342261ee1afe005036-38937155',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.7',
  'unifunc' => 'content_61ee1afe1f7d7',
  'variables' => 
  array (
    'RECORD' => 0,
    'MODULE_MODEL' => 0,
...
<?php if ($_valid && !is_callable('content_61ee1afe1f7d7')) {function content_61ee1afe1f7d7($_smarty_tpl) {?>
...
?><?php if ($_smarty_tpl->tpl_vars['DETAIL_VIEW_BASIC_LINK']->value->getLabel()=="LBL_EDIT"&&($_smarty_tpl->tpl_vars['IS_EDIT']->value||$_smarty_tpl->tpl_vars['MODULE_NAME']->value=='CSCProducts'||$_smarty_tpl->tpl_vars['MODULE_NAME']->value=='CSCSalesOrder')){?><?php continue 1?><?php }?><button class="btn btn-default" id="<?php echo $_smarty_tpl->tpl_vars['MODULE_NAME']->value;?>
...
</button><?php } ?><?php if (count($_smarty_tpl->tpl_vars['DETAILVIEW_LINKS']->value['DETAILVIEW'])>0){?><?php if ($_smarty_tpl->tpl_vars['MODULE_NAME']->value!='CSCSalesOrder'){?><button class="btn btn-default dropdown-toggle" data-toggle="dropdown" href="javascript:void(0);"><?php echo vtranslate('LBL_MORE',$_smarty_tpl->tpl_vars['MODULE_NAME']->value);?>
...
?><?php if ($_smarty_tpl->tpl_vars['DETAIL_VIEW_LINK']->value->getLabel()==''){?><li class="divider"></li><?php }else{ ?><?php if ($_smarty_tpl->tpl_vars['MODULE_NAME']->value=="HelpDesk"&&$_smarty_tpl->tpl_vars['DETAIL_VIEW_LINK']->value->getLabel()=="Generate to Invoice"){?><?php $_smarty_tpl->tpl_vars['TICKETSTATUS'] = new Smarty_variable($_smarty_tpl->tpl_vars['RECORD']->value->get('ticketstatus'), null, 0);?><?php $_smarty_tpl->tpl_vars['INVOICEPATTERN'] = new Smarty_variable($_smarty_tpl->tpl_vars['RECORD']->value->get('invoice_pattern'), null, 0);?><?php if (!($_smarty_tpl->tpl_vars['TICKETSTATUS']->value=="Closed"&&$_smarty_tpl->tpl_vars['INVOICEPATTERN']->value=="Need")){?><?php continue 1?><?php }?><?php $_smarty_tpl->tpl_vars['ALREADY_GENERATE'] = new Smarty_variable(HelpDesk_Module_Model::getGenerateInvoice($_smarty_tpl->tpl_vars['RECORD']->value->get('ticket_no')), null, 0);?><?php if ($_smarty_tpl->tpl_vars['ALREADY_GENERATE']->value){?><li id="<?php echo $_smarty_tpl->tpl_vars['MODULE_NAME']->value;?>
...
"><a><?php echo vtranslate('LBL_ALREADY_GENERATE_INVOICE',$_smarty_tpl->tpl_vars['MODULE_NAME']->value);?>
</a><?php continue 1?></li><?php }?><?php }?><li id="<?php echo $_smarty_tpl->tpl_vars['MODULE_NAME']->value;?>
_detailView_moreAction_<?php echo Vtiger_Util_Helper::replaceSpaceWithUnderScores($_smarty_tpl->tpl_vars['DETAIL_VIEW_LINK']->value->getLabel());?>
