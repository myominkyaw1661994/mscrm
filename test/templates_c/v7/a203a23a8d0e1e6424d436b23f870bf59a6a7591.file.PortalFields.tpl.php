<?php /* Smarty version Smarty-3.1.7, created on 2021-01-21 14:35:37
         compiled from "F:\Project\MSCRM_Release\includes\runtime/../../layouts/v7\modules\Settings\CustomerPortal\PortalFields.tpl" */ ?>
<?php /*%%SmartyHeaderCode:2605515075ffd217455f267-74457548%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'a203a23a8d0e1e6424d436b23f870bf59a6a7591' => 
    array (
      0 => 'F:\\Project\\MSCRM_Release\\includes\\runtime/../../layouts/v7\\modules\\Settings\\CustomerPortal\\PortalFields.tpl',
      1 => 1610605519,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2605515075ffd217455f267-74457548',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.7',
  'unifunc' => 'content_5ffd21746a881',
  'variables' => 
  array (
    'MODULE' => 0,
    'ALLFIELDS' => 0,
...
<?php if ($_valid && !is_callable('content_5ffd21746a881')) {function content_5ffd21746a881($_smarty_tpl) {?>
...
?><?php if ($_smarty_tpl->tpl_vars['VALUE']->value['name']!='Export'){?><div class="checkbox label-checkbox"<?php if (!vtlib_isModuleActive($_smarty_tpl->tpl_vars['VALUE']->value['name'])&&$_smarty_tpl->tpl_vars['VALUE']->value['name']!='History'){?> hidden <?php }?>><label><input class="relmoduleinfo_<?php echo $_smarty_tpl->tpl_vars['MODULE']->value;?>
...
</label><br></div><?php }else{ ?><?php $_smarty_tpl->tpl_vars['EXPORT_VALUE'] = new Smarty_variable($_smarty_tpl->tpl_vars['VALUE']->value, null, 0);?><?php }?><?php } ?><?php }?></div><?php }?><br><?php if ($_smarty_tpl->tpl_vars['MODULE']->value=='HelpDesk'||$_smarty_tpl->tpl_vars['MODULE']->value=='Assets'){?><h4><?php echo vtranslate('LBL_RECORD_PERMISSIONS',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
...
</label><br></div><?php if ($_smarty_tpl->tpl_vars['MODULE']->value=='HelpDesk'&&$_smarty_tpl->tpl_vars['EXPORT_VALUE']->value){?><?php $_smarty_tpl->tpl_vars['VALUE'] = new Smarty_variable($_smarty_tpl->tpl_vars['EXPORT_VALUE']->value, null, 0);?><div class="checkbox label-checkbox"><label><input class="relmoduleinfo_<?php echo $_smarty_tpl->tpl_vars['MODULE']->value;?>
" data-relmodule ="<?php echo $_smarty_tpl->tpl_vars['VALUE']->value['name'];?>
" type="checkbox" name="<?php echo $_smarty_tpl->tpl_vars['VALUE']->value['name'];?>
" id="<?php echo $_smarty_tpl->tpl_vars['VALUE']->value['name'];?>
" value="<?php echo $_smarty_tpl->tpl_vars['VALUE']->value['value'];?>
" <?php if ($_smarty_tpl->tpl_vars['VALUE']->value['value']){?>checked<?php }?>/> <?php echo vtranslate($_smarty_tpl->tpl_vars['VALUE']->value['name'],$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
</label><br></div><?php }?></div><?php }?></div></div>
<?php }} ?>