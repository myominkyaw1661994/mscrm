<?php /* Smarty version Smarty-3.1.7, created on 2022-01-28 14:53:39
         compiled from "E:\xampp\htdocs\CSC0tester\includes\runtime/../../layouts/v7\modules\Vtiger\SummaryViewContents.tpl" */ ?>
<?php /*%%SmartyHeaderCode:172692395061ee1afea4f384-43932820%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'c17668f74a91e4d4a7c05b21ba695428de76392d' => 
    array (
      0 => 'E:\\xampp\\htdocs\\CSC0tester\\includes\\runtime/../../layouts/v7\\modules\\Vtiger\\SummaryViewContents.tpl',
      1 => 1643356938,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '172692395061ee1afea4f384-43932820',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.7',
  'unifunc' => 'content_61ee1afec1ac2',
  'variables' => 
  array (
...
<?php if ($_valid && !is_callable('content_61ee1afec1ac2')) {function content_61ee1afec1ac2($_smarty_tpl) {?>
...
</span><?php if ($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->isEditable()=='true'&&$_smarty_tpl->tpl_vars['IS_AJAX_ENABLED']->value&&$_smarty_tpl->tpl_vars['FIELD_MODEL']->value->isAjaxEditable()=='true'&&$_smarty_tpl->tpl_vars['FIELD_MODEL']->value->get('uitype')!=69){?><?php if (!($_smarty_tpl->tpl_vars['IS_EDIT']->value)&&!($_smarty_tpl->tpl_vars['MODULE_NAME']->value=='HelpDesk'&&($_smarty_tpl->tpl_vars['FIELD_NAME']->value=="parent_id"||$_smarty_tpl->tpl_vars['FIELD_NAME']->value=="contact_id"||$_smarty_tpl->tpl_vars['FIELD_NAME']->value=="product_id"||$_smarty_tpl->tpl_vars['FIELD_NAME']->value=="ticketstatus"||$_smarty_tpl->tpl_vars['FIELD_NAME']->value=="machine_serial_no"||$_smarty_tpl->tpl_vars['FIELD_NAME']->value=="invoice_pattern"||$_smarty_tpl->tpl_vars['FIELD_NAME']->value=="engineer_name"||$_smarty_tpl->tpl_vars['FIELD_NAME']->value=="customer_name"))&&!($_smarty_tpl->tpl_vars['MODULE_NAME']->value=='CSCProducts'&&($_smarty_tpl->tpl_vars['FIELD_NAME']->value!="productcategory1"&&$_smarty_tpl->tpl_vars['FIELD_NAME']->value!="productcategory2"))&&$_smarty_tpl->tpl_vars['MODULE_NAME']->value!='CSCSalesOrder'){?><span class="hide edit"><?php if ($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->getFieldDataType()=='multipicklist'){?><input type="hidden" class="fieldBasicData" data-name='<?php echo $_smarty_tpl->tpl_vars['FIELD_MODEL']->value->get('name');?>
...
" data-displayvalue='<?php echo Vtiger_Util_Helper::toSafeHTML($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->getDisplayValue($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->get('fieldvalue')));?>
' data-value="<?php echo $_smarty_tpl->tpl_vars['FIELD_MODEL']->value->get('fieldvalue');?>
" /><?php }?></span><?php if (!($_smarty_tpl->tpl_vars['FIELD_NAME']->value=="account_id"&&$_smarty_tpl->tpl_vars['MODULE']->value=='Contacts')){?><span class="action"><a href="#" onclick="return false;" class="editAction fa fa-pencil"></a></span><?php }?><?php }?><?php }?></div></td></tr><?php }?><?php } ?></tbody></table><?php }} ?>