<?php /* Smarty version Smarty-3.1.7, created on 2020-09-24 11:18:24
         compiled from "/var/www/html/maintcrm20i15/includes/runtime/../../layouts/v7/modules/Vtiger/DetailViewActions.tpl" */ ?>
<?php /*%%SmartyHeaderCode:21467751735f62fb74901d75-25417295%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'e4db117432b70ea48dde98064bae03a56238248b' => 
    array (
      0 => '/var/www/html/maintcrm20i15/includes/runtime/../../layouts/v7/modules/Vtiger/DetailViewActions.tpl',
      1 => 1600943117,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '21467751735f62fb74901d75-25417295',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.7',
  'unifunc' => 'content_5f62fb749247a',
  'variables' => 
  array (
    'RECORD' => 0,
    'MODULE_MODEL' => 0,
...
<?php if ($_valid && !is_callable('content_5f62fb749247a')) {function content_5f62fb749247a($_smarty_tpl) {?>
...
&nbsp;&nbsp;<i class="caret"></i></button><ul class="dropdown-menu dropdown-menu-right"><?php $_smarty_tpl->tpl_vars['TICKETSTATUS'] = new Smarty_variable($_smarty_tpl->tpl_vars['RECORD']->value->get('ticketstatus'), null, 0);?><?php $_smarty_tpl->tpl_vars['INVOICEPATTERN'] = new Smarty_variable($_smarty_tpl->tpl_vars['RECORD']->value->get('invoice_pattern'), null, 0);?><?php  $_smarty_tpl->tpl_vars['DETAIL_VIEW_LINK'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['DETAIL_VIEW_LINK']->_loop = false;
...
?><?php if ($_smarty_tpl->tpl_vars['DETAIL_VIEW_LINK']->value->getLabel()==''){?><li class="divider"></li><?php }else{ ?><?php if ($_smarty_tpl->tpl_vars['MODULE_NAME']->value=="HelpDesk"){?><?php if ($_smarty_tpl->tpl_vars['DETAIL_VIEW_LINK']->value->getLabel()=="Generate to Invoice"&&!($_smarty_tpl->tpl_vars['TICKETSTATUS']->value=="Closed"&&$_smarty_tpl->tpl_vars['INVOICEPATTERN']->value=="Need")){?><?php continue 1?><?php }?><?php }?><li id="<?php echo $_smarty_tpl->tpl_vars['MODULE_NAME']->value;?>
