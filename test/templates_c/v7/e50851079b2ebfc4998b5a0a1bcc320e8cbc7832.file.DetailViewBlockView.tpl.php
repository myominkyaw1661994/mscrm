<?php /* Smarty version Smarty-3.1.7, created on 2020-09-24 12:27:21
         compiled from "/var/www/html/maintcrm20i15/includes/runtime/../../layouts/v7/modules/Vtiger/DetailViewBlockView.tpl" */ ?>
<?php /*%%SmartyHeaderCode:7032320305f62fb749c2ff1-70314894%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'e50851079b2ebfc4998b5a0a1bcc320e8cbc7832' => 
    array (
      0 => '/var/www/html/maintcrm20i15/includes/runtime/../../layouts/v7/modules/Vtiger/DetailViewBlockView.tpl',
      1 => 1600950437,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '7032320305f62fb749c2ff1-70314894',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.7',
  'unifunc' => 'content_5f62fb74a29f5',
  'variables' => 
  array (
...
<?php if ($_valid && !is_callable('content_5f62fb74a29f5')) {function content_5f62fb74a29f5($_smarty_tpl) {?>
...
</span><?php if ($_smarty_tpl->tpl_vars['IS_AJAX_ENABLED']->value&&$_smarty_tpl->tpl_vars['FIELD_MODEL']->value->isEditable()=='true'&&$_smarty_tpl->tpl_vars['FIELD_MODEL']->value->isAjaxEditable()=='true'){?><?php if (!($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->getName()=='parent_id'&&$_smarty_tpl->tpl_vars['MODULE_NAME']->value=='HelpDesk')){?><span class="hide edit pull-left"><?php if ($_smarty_tpl->tpl_vars['fieldDataType']->value=='multipicklist'){?><input type="hidden" class="fieldBasicData" data-name='<?php echo $_smarty_tpl->tpl_vars['FIELD_MODEL']->value->get('name');?>
