<?php /* Smarty version Smarty-3.1.7, created on 2022-01-25 14:03:17
         compiled from "E:\xampp\htdocs\CSC0tester\includes\runtime/../../layouts/v7\modules\Inventory\partials\LineItemsEdit.tpl" */ ?>
<?php /*%%SmartyHeaderCode:110853124561efa7bd176ee1-90210363%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'ea9111a8024184601978790bdd3f3db4018bc2ab' => 
    array (
      0 => 'E:\\xampp\\htdocs\\CSC0tester\\includes\\runtime/../../layouts/v7\\modules\\Inventory\\partials\\LineItemsEdit.tpl',
      1 => 1605677022,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '110853124561efa7bd176ee1-90210363',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_61efa7bdb8084',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_61efa7bdb8084')) {function content_61efa7bdb8084($_smarty_tpl) {?>
...
" /><input type="hidden" value="<?php echo $_smarty_tpl->tpl_vars['SELECTED_CURRENCY']->value['currency_id'];?>
" id="selectedCurrencyId" /><p class="message-text hide" style="color:#D95252;margin-top: 3px;">Please must be click "Save" button for change currency.</p></center></div><div class="col-lg-4 col-md-4 col-sm-4" style="top: 3px;"><div style="float: right;"><i class="fa fa-info-circle"></i>&nbsp;<label><?php echo vtranslate('LBL_TAX_MODE',$_smarty_tpl->tpl_vars['MODULE']->value);?>
...
<?php }else{ ?>0<?php }?>"></span><?php }else{ ?><span class="pull-right"><input id="paid" name="paid" type="text" class="lineItemInputBox form-control" value="<?php if ($_smarty_tpl->tpl_vars['RECORD']->value->getDisplayValue('paid')&&!($_smarty_tpl->tpl_vars['IS_DUPLICATE']->value)){?><?php echo $_smarty_tpl->tpl_vars['RECORD']->value->getDisplayValue('paid');?>
